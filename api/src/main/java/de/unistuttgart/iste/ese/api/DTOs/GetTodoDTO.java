...
public class GetTodoDTO {
    ...
    public GetTodoDTO(Long id, String title, String description, boolean finished, List<Assignee> assigneeList, Long createdDate, Long dueDate, Long finishedDate, String category) {
        this.id = id;
        this.title = title;
